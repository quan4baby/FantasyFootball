...
public class DBHandler extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_PLAYER_POSTION = "postion";
     ...
     * @param position player year
     * @param team player major
     */
    public void add(String name, String position, String team) {
        ...
        values.put(COLUMN_PLAYER_POSTION, position);
     ...
     * @param team selected team (Eagles, Steelers, or Cowboys)
